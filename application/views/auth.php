            ...
            <div class="card-body">
                ...
                <div class="form-group has-feedback">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" value="<?= set_value('email') ?>" id="email" name="email" class="form-control" placeholder="Enter Email.." data-required-error="Email Tidak Boleh Kosong" required>
                    </div>
        ...
        <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
            <div class="card-body text-center">
                <div>
                    ...
                    <button class="btn btn-primary active mt-3 btn-register" type="button">Register Now!</button>
                </div>
            </div>
        </div>
    </div>
